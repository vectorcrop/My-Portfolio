...
<div class="nav-wrapper">
    <a href="#!" class="brand-logo"><h5><b>Mishab</b></h5></a>
    ...
    <ul class="right hide-on-med-and-down">
        ...
        <li><a class="white-text" href="http://www.msb.epizy.com">Blog</a></li>
        <li><a class="white-text" href="#contact">Contact</a></li>

        <li><a class="white-text" href="404.html" target="_blank">My Resume</a></li>
...
<li><a href="http://www.msb.epizy.com">Blog</a></li>
...
<div class="webintern-footer-inner" id="contact">
  <div class="container">
    <div class="row">
      <div class="col-lg-7 col-md-6 pt-3" >
      <div class="col-sm-6 col-md-7">
        <a class="webintern-footer-logo" href="#">
          <center><a href="#!" class="brand-logo"><h5 class="h5style"><b>Mishab</b></h5></a></center>
        </a>
...
<div class="social-icons-footer">
  ...
  <a class="social-icon-footer instagram" href="https://www.instagram.com/mis_hab.__/" target="_blank" rel="author">
  ...
  <a class="social-icon-footer gitlab" href="https://gitlab.com/MishabMsb" target="_blank" rel="author">
    <i class="fab fa-gitlab"></i>
      </a>
  <a class="social-icon-footer github" href="https://github.com/MSB-CREATION" target="_blank" rel="author">
    <i class="fab fa-github"></i>
      </a>
  <br>
<p style="color:white;><a href=" ">msb.com001@gmail.com</a></p>
</div>
    </div>
